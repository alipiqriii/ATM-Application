...
public class TVSatelite extends Transaction {
   String tvSatelite;
   ...
   public TVSatelite(int userAccountNumber, Screen atmScreen, 
   ...
   public void execute() {
       ...
       if(super.getScreen().getID() == "ID") tvSatelite = "Pembayaran TV Kabel";
       else tvSatelite = "Payment TV Cable";
       ...
       if(amount != CANCELED){
            ...
            if(amount <= availableBalance){
                ...
                screen.displayPaymentSuccess(tvSatelite);
            }
            else {
                screen.displayBalanceInsfulence(tvSatelite, availableBalance, amount);
            }
       }
       else {
